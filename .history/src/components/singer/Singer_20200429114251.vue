<template>
  <div>
    <div class="content flex a-center">
      ...
      <div class="item flex a-center" v-for="(item, index) in lang" :key="index" >
    ...
    <div class="content flex a-center">
      ...
      <div class="item flex a-center" v-for="(item, index) in category" :key="index" >
        <div class="name" :class="{active: caIndex === index}">{{item.name}}</div>
        <div class="line" v-if='index !== lang.length - 1'></div>
      </div>
    </div>
    <div class="content flex a-center">
      <div class="title">筛选:</div>
      <div class="item flex a-center" v-for="(item, index) in initials" :key="index" >
