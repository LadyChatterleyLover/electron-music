<template>
  <div>
    <div class="content flex a-center">
      ...
      <div class="item flex a-center" v-for="(item, index) in lang" :key="index" @click="clickLang(item, index)">
    ...
    <div class="content flex a-center">
      ...
      <div class="item flex a-center" v-for="(item, index) in category" :key="index" @click="clickCategory(item, index)">
    ...
    <div class="content flex a-center">
      ...
      <div class="item flex a-center" v-for="(item, index) in initials" :key="index" @click="clickInitial(item, index)">
