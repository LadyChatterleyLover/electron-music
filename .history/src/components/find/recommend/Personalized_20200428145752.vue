<template>
  <div class="personal">
    ...
    <div class="content flex a-center">
      <div v-for="(item, index) in recommends" :key="item.id" class="item" @mouseenter="enter(item)" @mouseleave="leave(item)">
        <div class="copywriter flex a-center j-center" :class="{hoverwriter: item.showHover}">
          <div class="c-desc">{{item.copywriter}}</div>
        </div>
